...
public class GetMarlinStatusCommand extends GcodeCommand {
...
//ok
    ...
    public void appendResponse(String response) {
        ...
        if (MarlinUtils.isMarlinStatusString(response)) {
    ...
    private void parseControllerStatus(String response) {
        controllerStatus = MarlinUtils.getStatusFromStatusStringLegacy(response, UnitUtils.Units.MM);
