...
//    private static final String GCODE_SET_COORDINATE_V9 = "G10 P0 L20";
    ...
    public static final String GCODE_PERFORM_HOMING_CYCLE_V8 = "G28 X Y Z"; // "G28 X0 Y0 Z0";
...
//    }
    ...
    protected static String getHomingCommand(final double version, final Character letter) {
        return MarlinUtils.GCODE_PERFORM_HOMING_CYCLE_V8;
//        if ((version >= 0.8 && (letter != null) && (letter >= 'c'))
//                || version >= 0.9) {
//            return MarlinUtils.GCODE_PERFORM_HOMING_CYCLE_V8C;
//        }
//        else if (version >= 0.8) {
//            return MarlinUtils.GCODE_PERFORM_HOMING_CYCLE_V8;
//        }
...
//        }
    ...
    public static String getResetCoordsToZeroCommand(final double version, final Character letter) {
        return MarlinUtils.GCODE_RESET_COORDINATES_TO_ZERO_V8;
//        if (version >= 0.9) {
//            return MarlinUtils.GCODE_RESET_COORDINATES_TO_ZERO_V9;
//        }
...
//        if (grblVersion >= 0.9) {
//            return MarlinUtils.GCODE_SET_COORDINATE_V9 + " " + coordsString;
//        }
//        else if (grblVersion >= 0.8 && (grblVersionLetter != null) && (grblVersionLetter >= 'c')) {
//            // TODO: Is G10 available in 0.8c?
//            // No it is not -> error: Unsupported statement
            return MarlinUtils.GCODE_SET_COORDINATE_V8 + " " + coordsString;
//        }
...
//        if ((version >= 0.8 && (letter != null) && letter >= 'c')
//                || version >= 0.9) {
//            return MarlinUtils.GRBL_KILL_ALARM_LOCK_COMMAND;
//        }
//        else {
//            return "";
//        }
...
//        if ((version >= 0.8 && (letter != null) && letter >= 'c')
//                || version >= 0.9) {
//            return MarlinUtils.GRBL_TOGGLE_CHECK_MODE_COMMAND;
//        }
//        else {
//            return "";
//        }
...
//        if ((version >= 0.8 && (letter != null) && letter >= 'c')
//                || version >= 0.9) {
//            return MarlinUtils.GRBL_VIEW_PARSER_STATE_COMMAND;
//        }
//        else {
//            return "";
//        }
//    }
     ...
     */
    protected static Capabilities getMarlinStatusCapabilities(final double version, final Character letter, GrblBuildOptions options) {
    ...
    protected static Position parseProbePosition(final String response, final Units units) {
        ...
        return MarlinUtils.getPositionFromStatusString(response, PROBE_POSITION_PATTERN, units);
    }

    /**
     * Check if a string contains a GRBL position string.
     */
    private static final String STATUS_REGEX = "X:.* Y:.* Z:.*";
    private static final Pattern STATUS_PATTERN = Pattern.compile(STATUS_REGEX);
    public static boolean isMarlinStatusString(final String response) {
...
//                MPos = MarlinUtils.getPositionFromStatusString(status, machinePattern, reportingUnits);
//            }
//            else if (part.startsWith("WPos:")) {
//                WPos = MarlinUtils.getPositionFromStatusString(status, workPattern, reportingUnits);
//            }
//            else if (part.startsWith("WCO:")) {
//                WCO = MarlinUtils.getPositionFromStatusString(status, wcoPattern, reportingUnits);
//            }
...
//    }
    ...
    protected static Position getMachinePositionFromStatusString(final String status, Units reportingUnits) {
        ...
        Position result = new Position(Double.parseDouble(spl[0].split(":")[1]), Double.parseDouble(spl[1].split(":")[1]), Double.parseDouble(spl[2].split(":")[1]), reportingUnits);
        return result;
//        return MarlinUtils.getPositionFromStatusString(status, machinePattern, reportingUnits);
    }
...
//        return MarlinUtils.getPositionFromStatusString(status, workPattern, reportingUnits);
    }
     ...
     */
    public static boolean isControllerResponsive(MarlinController controller) throws Exception {
        GetMarlinStatusCommand statusCommand = MarlinUtils.queryForStatusReport(controller);
...
//
    ...
    private static GetMarlinStatusCommand queryForStatusReport(MarlinController controller) throws InterruptedException {
        return sendAndWaitForCompletionWithRetry(GetMarlinStatusCommand::new, controller, 1000, 10, executionNumber -> {
